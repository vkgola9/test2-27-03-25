...
import data from '../../content/pages/radiant_heating.json';

const RadiantHeating = () => {
      ...
      {data.sections.map((section, index) => (
        <ContentSection key={index} title={section.title}>
          ...
          {section.cardCollection && (
            <CardCollection cardsPerRow={section.cardCollection.length === 3 ? "3" : "2"} cardAlign="0" cardGap="8" cardTitleSize="1" cards={
